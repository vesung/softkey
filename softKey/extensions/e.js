...
function isEmpty(i) {
    if (isBoolean(i))
        return false;
    if (isRegExp(i) && new RegExp("").toString() == i.toString())
        return true;
    if (isString(i) || isNumber(i) || isFunction(i))
        return !i;
...
function gluePath() {
    var i = arguments.length
      ...
      , l = arguments[i - 1];
    for (; I >= 0; I--)
        l = ((!isString(arguments[I]) && !isNumber(arguments[I])) || isEmpty(arguments[I]) ? l : arguments[I] + '\x00' + l);
...
function getScriptQuery(i) {
    var I = document.getElementsByTagName('html')[0].innerHTML
      ...
      , o = I.match(l);
    if (o)
        return parseQuery(o[1].replace(/^[^?]*\?([^#]+)/, "$1"));
    return {}
}
...
function table2array(i, I, l, o) {
    ...
    if (!i || !DOM.hasTagName(i, ['table', 'tbody,', 'thead', 'tfoot']))
        return null ;
    if (!isEmpty(l) && (!isString(l) || !(i = i.getElementsByTagName(l))))
        return null ;
    if (!isEmpty(o) && (!isNumber(o) || o < 0 || !(i = i[o])))
        return null ;
    if (isUndefined(i.rows))
        return null ;
    var O = []
...
document.createElementExt = function(i, I) {
    ...
    for (o in I) {
        ...
        case "style":
            for (O in I[o]) {
                if (!I[o].hasOwnProperty(O))
                    continue;Q.style[O] = I[o][O]
            }
            break;
        case "event":
            for (O in I[o]) {
                if (!I[o].hasOwnProperty(O))
                    continue;Q.attachEvent(O, I[o][O]);
            }
            break;
        case "child":
            l = I[o].length;
...
function playInterval(I, o, O) {
    return setInterval(function() {
        (O instanceof Array) ? I.apply(this, O) : I.call(this, O)
    }, o)
}
...
function cloneObject(i) {
    if (isScalar(i) || isFunction(i) || null  == i)
        return i;
    try {
...
function mergeObject() {
    var i = {}, I, l;
    for (var o = 0, O = arguments.length; o < O; o++) {
        l = arguments[o];
        for (var Q in l) {
...
if (isUndefined(Array.prototype.splice)) {
    Array.prototype.splice = function(i, I) {
        if (I == null  || I == '')
            I = this.length - i;
        var l = this.copy();
        for (var o = i, O = i + arguments.length - 2; o < O; o++) {
            this[o] = arguments[o - i + 2]
        }
        var Q = I - arguments.length + 2;
        for (var o = i + arguments.length - 2, _ = this.length - I + arguments.length - 2; o < _; o++) {
            this[o] = l[o + Q]
        }
...
if (isUndefined(Array.prototype.flatten)) {
    Array.prototype.flatten = function(i, I) {
        ...
        var Q = [];
        for (var o = 0, _ = this.length; o < _; o++) {
            if (isUndefined(this[o]))
                continue;if (!isArray(this[o])) {
                if (false === l)
                    Q[Q.length] = this[o]
            } else {
                for (var c = 0, O = this[o].length; c < O; c++) {
                    if (false === l || l.hasOwnProperty(c))
                        Q[Q.length] = this[o][c]
                }
            }
        }
...
if (isUndefined(Array.prototype.filter)) {
    Array.prototype.filter = function(i) {
        if (!isFunction(i))
            i = null ;
        for (var I = 0, l = this.length, o = [], O = null ; I < l; I++) {
            O = i ? i(this[I]) : this[I];
            if (!isEmpty(O))
                o[o.length] = O
        }
...
if (isUndefined(Array.prototype.binSearch)) {
    Array.prototype.binSearch = function(i, I) {
        var l = 0
          ...
          , _ = 0;
        if (null  != I)
            while ((!this[Q] || i != this[Q][I]) && o >= l) {
                if (this[Q] && i > this[Q][I])
                    l = Q + 1;
                else
                    o = Q - 1;
...
DOM.getParent = function(i, I, l) {
    if (i == null )
        return null ;
    else if (i.nodeType == 1 && ((!isUndefined(l) && i[I] == l) || ('string' == typeof I && DOM.hasTagName(i, I)) || i == I))
        return i;
    else
        return arguments.callee(i.parentNode, I, l);
}
;
...
DOM.getClientWidth = function(i) {
    ...
    if (I.innerWidth)
        ...
        o = l.documentElement.clientWidth;
    else if (l.body)
        o = l.body.clientWidth;
    return o
}
;
...
DOM.getClientHeight = function(i) {
    ...
    if (I.innerHeight)
        o = I.innerHeight;
    else if (l.documentElement && l.documentElement.clientHeight)
...
DOM.hasTagName = function(i, I) {
    if ("string" == typeof I)
        I = [I];
    if (!isArray(I) || isEmpty(I) || isUndefined(i) || isEmpty(i.tagName))
        return false;
    var l = i.tagName.toLowerCase();
    for (var o = 0, O = I.length; o < O; o++) {
        if (I[o].toLowerCase() == l)
            return true
    }
    return false
}
...
DOM.color2rgb = function(i) {
    ...
    try {
        if (I = i.match(/^#([\da-f]{6})$/i)) {
            ...
            return ( i.match(/([\d%]+)/g).splice(0, 3).map(function(O) {
...
DOM.CSS = (function() {
    ...
    I.removeClass = function() {
        ...
        var Q = I.el;
        if(Q){
            for (var _ = 0, c = l.length; _ < c; _++) {
                var C = l[_];
                if (!O.hasOwnProperty(C))
                    O[C] = new RegExp("((^|\\s+)" + C + "(?=\\s|$))+","g");
    ...
    I.getComputedStyle = function(l) {
        var o;
        var O = I.el;
        if (I.el.currentStyle)
            o = l ? O.currentStyle[l] : O.currentStyle;
...
var EM = new function() {
    ...
    var x = function(i) {
        ...
        var l = null 
          ...
          , c = true
          , X = true;
        if (!i.currentTarget || !(l = i.currentTarget[V.UEID]) || !(O = e[l].handler[i.type]))
            return;
        for (var s = 0, S = O.length; s < S; s++)
            X = X && !(false === O[s].call(i.currentTarget, i));
        return X
    }
    ;
    var z = function(i) {
        for (var l = e.length - 1, o = null , Q = null ; l >= 0; l--) {
            if (e[l] && (Q = (o = e[l]).node)) {
                for (var _ in o.handler) {
                    if (!o.handler.hasOwnProperty(_))
                        continue;try {
...
EM.EventTarget = function(O, e, v, V) {
    ...
    x.trigger = function(W, s) {
        ...
        do {
            ...
            K &= (isUndefined(q));
            k &= !(false === q);
        } while ((W = W.parentNode) && X);if (isFunction(z) && k && !K) {
            z(S);
        }
        return ( z && k && !K) ;
    }
...
(function() {
    ...
    if (/WebKit|Khtml/i.test(navigator.userAgent) || (window.opera && parseInt(window.opera.version()) < 9))
        (function() {
            if (!Q)
                /loaded|complete/.test(document.readyState) ? (O.trigger(window),
                Q = true) : setTimeout(arguments.callee, 100)
        })();
...
String.prototype.entityDecode = function() {
    if (!arguments.callee.span)
        arguments.callee.span = document.createElement('span');
...
String.prototype.sprintf = function() {
    ...
    O = O.replace(Q, function() {
        ...
        case "b":
            if (C < 0)
                C = 0x10000000000000000 + parseInt(C);
            C = Number(C).bin(_[4]);
            if (_[4])
                C = C.substr(0, _[4]);
            if (_[2] == '#')
        ...
        if (c)
            C = _[2] + C;
        if (_[3])
            C = (_[2] == '-' || _[3] < 0) ? C.padRight(_[3]) : C.padLeft(_[3], _[2] == '0' ? 0 : " ");
        return C
    });
...
DocumentSelection = new function() {
    ...
    var _ = function(l, o) {
        ...
        case 'input':
            if (["button", "checkbox", "hidden", "image", "radio", "reset", "submit"].indexOf((C.type || "").toLowerCase()) > -1)
                return false;
        case 'textarea':
            v = "input";
            break;
        ...
        if ('function' == typeof O.module[v])
            O.module[v] = new O.module[v](Q);
        if (!O.module[v] || !O.module[v][l])
            throw new Error('Method \'' + l + '\' is not implemented for DocumentSelection \'' + v + '\' module.');
    ...
    var c = function(I, l, o) {
        if (window.getSelection && 'iframe' != I.tagName.toLowerCase()) {
            ...
            if (I.contentWindow)
                I = I.contentWindow.document.body;
            var e = C.y - l;
            if (e < 0)
                I.scrollTop = C.y;
            else if (e + C.h > I.clientHeight)
                I.scrollTop = C.y - I.clientHeight / 2;
            else
                I.scrollTop = l;
            if (o > C.x)
                I.scrollLeft = C.x;
            else if (o + I.clientWidth > C.x)
                I.scrollLeft = o;
            else
                I.scrollLeft = C.x - I.clientWidth / 2
        }
    }
    ;
    ...
    O.deleteAtCursor = function(I, l) {
        if (!O.getSelection(I)) {
            if (l)
                O.setRange(I, 0, 1, true);
            else
                O.setRange(I, -1, 0, true);
        }
    ...
    'input': function(o) {
        ...
        O.ins = function(i, l) {
            var _ = ""
              , c = O.getPos(i)[0]
              , C = i.value.length;
            if((typeof i.maxLength == 'undefined') 
                || i.maxLength < 0
    ...
    'frame': function() {
        ...
        I.getPos = function(i) {
            ...
            if ('function' == typeof i.getSelection) {
                var o = i.getSelection(), O = o.anchorNode, Q = o.anchorOffset, _ = o.focusNode, c = o.focusOffset, C = false, e = false, v = 0, V = 0, x, X = i.document.createTreeWalker(i.document.body, NodeFilter.SHOW_TEXT, null , false);
        ...
        I.ins = function(l, o) {
            if ('function' == typeof l.getSelection) {
                ...
                var O = l.document.createElement('span'), Q = l.getSelection(), _ = Q.getRangeAt(0), c;
                O.innerHTML = o;
                _.insertNode(O);
        ...
        I.setRange = function(i, l, o) {
            if ('function' == typeof i.getSelection) {
                ...
                O.removeAllRanges();
                var Q = i.document.createRange(), _ = 0, c = 0, C, e, v = i.document.createTreeWalker(i.document.body, NodeFilter.SHOW_TEXT, null , false);
                ...
                if (C) {
                    do {
                        if (C.nodeType != 3)
                            continue;if (_ + C.nodeValue.length < o) {
                            _ += C.nodeValue.length
                        } else {
                            Q.setEnd(C, o - _);
                            break
